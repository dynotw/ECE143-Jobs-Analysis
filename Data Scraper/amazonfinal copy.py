    ...
    for page in pages:
        try:
            ...
            response = get('https://www.amazon.jobs/en/search.json?base_query=&city=&country=USA&county'
                           ...
                           'facets%5B%5D=schedule_type_id&facets%5B%5D=employee_class&facets%5B%5D=normalized'
                           '_location&facets%5B%5D=job_function_id&job_function_id%5B%5D=job_function_'
                           'corporate_80rdb4&latitude=&loc_group_id=&loc_query=USA&longitude+USA&offset={}'
                           '&query_options=&radius=24km&region=&result_limit=10&schedule_type_id%5B%5D='
                           'Full-Time&sort=relevant'.format(page),
                           headers=headers,
